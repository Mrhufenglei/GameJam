...
namespace LocalModels
{
	public class LocalModelManager : BaseLocalModelManager
	{
		...
		public override void InitialiseLocalModels()
		{
			...
			localModels[LocalString_LocalStringModel.fileName] = LocalString_LocalStringModelInstance;


			Levels_tableModelInstance = new Levels_tableModel();
			localModels[Levels_tableModel.fileName] = Levels_tableModelInstance;


			Language_languagetableModelInstance = new Language_languagetableModel();
			localModels[Language_languagetableModel.fileName] = Language_languagetableModelInstance;
